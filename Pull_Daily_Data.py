...
holdings_ticker.loc[[1 for x in range(0, len(holdings_ticker['Ticker']))],'Ticker'].map(lambda x: x.strip())
daily_prices.loc[[1 for x in range(0, len(daily_prices['Ticker']))],'Ticker'].map(lambda x: x.strip())
